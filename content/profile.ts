...
export const profile: Profile = {
  name: "Christopher Garrett Moseley",
  initials: "CGM",
  title: "Software Engineering Lead",
  tagline:
    "Software Engineering Lead building resilient distributed systems and high-performance front ends.",
  shortBio:
    "Engineering lead at LexisNexis with seven years of experience leading teams across Java/Spring Boot backends, Angular and React front ends, and the micro-frontend architectures that connect them. Focused on platform reliability, developer experience, and shipping work that actually moves latency, throughput, or cost.",
  longBio:
